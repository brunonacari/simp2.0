...
SELECT 
    ...
    SUM(CASE WHEN DS_TIPO_PROBLEMA = 'COMUNICACAO' THEN 1 ELSE 0 END) AS PROB_COMUNICACAO,
    SUM(CASE WHEN DS_TIPO_PROBLEMA = 'MEDIDOR' THEN 1 ELSE 0 END) AS PROB_MEDIDOR,
    SUM(CASE WHEN DS_TIPO_PROBLEMA = 'HIDRAULICO' THEN 1 ELSE 0 END) AS PROB_HIDRAULICO,
...
PRINT '   View VW_DASHBOARD_RESUMO_GERAL criada.';

-- ============================================================================
-- VIEW 2: VW_PONTOS_POR_SCORE_SAUDE (versão completa)
-- ============================================================================
...
PRINT '   View VW_ANOMALIAS_RECENTES criada.';

-- View 4: Evolução Diária
...
PRINT '   View VW_EVOLUCAO_DIARIA criada.';
GO
...
-- Resumo geral dos últimos 7 dias
